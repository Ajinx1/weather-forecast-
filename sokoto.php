...
<div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
			        ...
			        <li <?php if ($activePage == "sok") {?> class="active" <?php } ?>><a href="sokoto.php"><i class="glyphicon glyphicon-globe"></i>Sokoto</a></li>
			
					<li <?php if ($activePage == "kn") {?> class="" <?php } ?>><a href="kano.php"><i class="glyphicon glyphicon-globe"></i>Kano</a></li>
					
					<li <?php if ($activePage == "ph") {?> class="" <?php } ?>><a href="ph.php"><i class="glyphicon glyphicon-globe"></i>Port Harcourt</a></li>
                </ul>
     ...
     <div class="container-fluid">
      ...
      <div class="row">
      <h3 class="ml-15 text-info">Sokoto, SOK</small></h3>
        <!-- CURRENT CONDITIONS -->
