...
<div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
					...
					<li <?php if ($activePage == "can") {?> class="active" <?php } ?>><a href="canada.php"><i class="glyphicon glyphicon-globe"></i>Canada</a></li>
     ...
     <div class="container-fluid">
      ...
      <div class="row">
      <h3 class="ml-15 text-info">Canada, CA</small></h3>
        <!-- CURRENT CONDITIONS -->
