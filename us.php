...
<div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
					...
					<li <?php if ($activePage == "us") {?> class="active" <?php } ?>><a href="us.php"><i class="glyphicon glyphicon-globe"></i>United state</a></li>
     ...
     <div class="container-fluid">
      ...
      <div class="row">
      <h3 class="ml-15 text-info">United state, US</small></h3>
        <!-- CURRENT CONDITIONS -->
