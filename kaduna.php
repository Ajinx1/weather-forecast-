...
<div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
					...
					<li <?php if ($activePage == "kad") {?> class="active" <?php } ?>><a href="kaduna.php"><i class="glyphicon glyphicon-globe"></i>Kaduna</a></li>
     ...
     <div class="container-fluid">
      ...
      <div class="row">
      <h3 class="ml-15 text-info">Kaduna, KAD</small></h3>
        <!-- CURRENT CONDITIONS -->
